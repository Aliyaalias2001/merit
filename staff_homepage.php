...
<body>
    ...
    <div class="slideshow-container">
        ...
        ?>
            <div class="mySlides fade">
                <img src="data:<?php echo $imageType; ?>;base64,<?php echo base64_encode($imageData); ?>" style="width:500px; height:400px;">
            </div>
        <?php
            $count++;
        }
    ...
    <div class="container">
        ...
        echo "<table id='upcoming-event' class='table table-striped table-bordered'>
                <tr>
                    <th>Name</th>
                    <th>Date</th>
                    <th>Location</th>
